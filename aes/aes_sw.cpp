...
{
    uint32_t *RK, X0, X1, X2, X3, Y0, Y1, Y2, Y3, V0, V1, V2, V3, Z0, Z1, Z2, Z3;
	int i;
	...
	{	    
    	RK = ctx->drk;
    	GET_UINT32( X0, data,  0 ); Z0 = X0; X0 ^= RK[0];
    	GET_UINT32( X1, data,  4 ); Z1 = X1; X1 ^= RK[1];
    	GET_UINT32( X2, data,  8 ); Z2 = X2; X2 ^= RK[2];
    	GET_UINT32( X3, data, 12 ); Z3 = X3; X3 ^= RK[3];
