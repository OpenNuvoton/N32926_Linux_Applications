...
if ./Src/GoldenImgMaker -O ../golden_imgmaker_x86/golden_yaffs2 -t ../golden_imgmaker_x86/TurboWriter_U6DN.ini -p 2048 -o 64 -s 64 -b 1024 \
                        ...
                        -P "../fs_writer_yaffs2/example_image/foo_yaffs2.img -t 0 -b 8 -O 0x1080000 -S 0x2000000"; then
	echo "========================================================================="
